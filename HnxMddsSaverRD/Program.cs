using HnxMddsSaverRD;
using HnxMddsSaverRD.BackgroundTasks;
...
IHost host = Host.CreateDefaultBuilder(args)
    .ConfigureServices((hostContext, services) =>
    {
        ...
        services.AddSingleton<IDataSaver, RedisDataSaver>();
        services.AddHostedService<HnxRedisConsumerWorker>();
    })
    .Build();
