...
namespace MddsSaver.Core.Shared.Entities
{
    ...
    public class EPriceLimitExpansion : EBase
    {
        ...
        //add trường mới - KhanhNV
        [JsonProperty(PropertyName = __TAG_30649, Order = 14)]
        public int PleUpLmtStep { get; set; }

        [JsonProperty(PropertyName = __TAG_30650, Order = 15)]
        public int PleLwLmtStep { get; set; }
    }
}
